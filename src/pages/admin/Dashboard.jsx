...
export default function Dashboard() {
  ...
  const chart = data?.chart || { weekly: [], monthly: [], yearly: [] }
  ...
  const statCards = stats ? [
    { label: 'Pemasukan Hari Ini', value: formatRp(stats.today_revenue), trend: `↑ ${stats.revenue_trend}% dari kemarin`, color: '#22c55e' },
    { label: 'Total Booking', value: stats.total_bookings.toLocaleString('id-ID'), trend: `↑ ${stats.booking_trend}% bulan ini` },
    { label: 'Pending Hari Ini', value: String(stats.pending_today), trend: stats.pending_today > 0 ? 'Butuh aksi' : 'Semua beres', color: stats.pending_today > 0 ? '#f59e0b' : '#22c55e' },
    { label: 'Selesai Hari Ini', value: String(stats.done_today), trend: 'Booking lunas', color: '#22c55e' },
  ] : []
