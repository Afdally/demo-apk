...
export default function Settings() {
  ...
  const [profile, setProfile] = useState({ studio_name: MOCK_SETTINGS.studio_name, studio_desc: MOCK_SETTINGS.studio_desc })
  const [contact, setContact] = useState({ contact_phone: MOCK_SETTINGS.contact_phone, contact_email: MOCK_SETTINGS.contact_email, contact_address: MOCK_SETTINGS.contact_address, contact_ig: MOCK_SETTINGS.contact_ig })
  const [payment, setPayment] = useState({ payment_bank: MOCK_SETTINGS.payment_bank, payment_number: MOCK_SETTINGS.payment_number, payment_name: MOCK_SETTINGS.payment_name })
  ...
  return (
    <div className="settings-page" style={{ paddingBottom: '80px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        ...
        <button onClick={handleSave} disabled={saving} className="admin-btn" style={{ margin: 0, width: 'auto', padding: '12px 24px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div className="dash-panel">
            <div className="dash-panel-header"><h3 className="dash-panel-title">Profil Studio</h3></div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div className="dash-panel">
            <div className="dash-panel-header"><h3 className="dash-panel-title">Info Kontak</h3></div>
