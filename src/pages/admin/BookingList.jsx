            ...
            <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
              ...
              <div className="filter-group" style={{ marginRight: '8px' }}>
                <div className="custom-select-wrapper">
                  <select className="admin-select" value={statusFilter} onChange={(e) => { setStatusFilter(e.target.value); setCurrentPage(1) }}>
              ...
              <div className="filter-group">
                <input type="date" className="admin-date-input" value={startDate} onChange={(e) => { setStartDate(e.target.value); setCurrentPage(1) }} />
                <span style={{ color: 'var(--text-45)', fontSize: '13px' }}>-</span>
                <input type="date" className="admin-date-input" value={endDate} onChange={(e) => { setEndDate(e.target.value); setCurrentPage(1) }} />
              </div>
            </div>
            <button
              className="admin-btn"
              style={{ margin: 0, width: 'auto', padding: '10px 20px', background: 'var(--text)', color: 'var(--primary)' }}
              onClick={() => alert('Fitur tambah booking — hubungkan ke backend untuk mode produksi')}
            >
              + Tambah Booking
            </button>
          </div>
