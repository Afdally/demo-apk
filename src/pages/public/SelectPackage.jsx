...
const PACKAGES = [
  { id: 'basic', badge: 'SOLO · 1 ORANG', name: 'Basic', duration: '60 menit', price: 150000, label: 'Rp150', unit: 'rb', features: ['1 background pilihan', 'Cetak 2 foto 4R', 'Soft file semua', 'Props dasar'] },
  { id: 'couple', badge: 'TERLARIS · 2 ORANG', badgeHot: true, name: 'Couple', duration: '90 menit', price: 250000, label: 'Rp250', unit: 'rb', features: ['2 background pilihan', 'Cetak 4 foto 4R', 'Soft file semua', 'Props lengkap'] },
  { id: 'family', badge: 'KELUARGA · MAX 6', name: 'Family', duration: '120 menit', price: 400000, label: 'Rp400', unit: 'rb', features: ['3 background pilihan', 'Cetak 8 foto 4R', 'Soft file semua', 'Album digital'] },
]
...
const ADDONS = [
  {
    ...
    ), name: 'Cetak foto tambahan', desc: '4 lembar ukuran 4R', price: 50000, label: '+Rp50rb',
  },
  {
    id: 'bg', icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    ...
    ), name: 'Background extra', desc: '1 background tambahan', price: 75000, label: '+Rp75rb',
  },
  {
    id: 'time', icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    ...
    ), name: 'Extra waktu', desc: 'Tambah 30 menit sesi', price: 100000, label: '+Rp100rb',
  },
  {
    id: 'makeup', icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
    ...
    ), name: 'Makeup artist', desc: 'Touch up profesional', price: 150000, label: '+Rp150rb',
  },
]
...
export default function SelectPackage() {
  ...
  const toggleAddon = (id) =>
    setCheckedAddons((prev) => prev.includes(id) ? prev.filter((a) => a !== id) : [...prev, id])

  const pkg = PACKAGES.find((p) => p.id === selectedPkg)
  const addonsTotal = ADDONS.filter((a) => checkedAddons.includes(a.id)).reduce((s, a) => s + a.price, 0)
        ...
        <div className="booking-footer-inner">
          <div className="footer-summary">
            ...
            <div className="footer-summary-sub">
              {checkedAddons.length > 0 ? `+${checkedAddons.length} layanan ekstra` : 'Tidak ada tambahan'}
            </div>
          </div>
